...
let factory = new RaidFactory()

describe('testing _getType()', () => {
    
    test('should return null with empty input ()', () => {
    ...
    test('should return null with undefined input (undefined)', () => {
        expect(factory._getType(undefined)).toBe(null)
    });
