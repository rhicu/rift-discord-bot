...
//DECLARE test data
var testCharacter1 = { charName: "Leroy Jenkins", shard: "SomeServer", owner: "JohnDoe", roles: ["Casualty", "Roadkill"], charClass: "Berzerk" };
var testCharacter2 = { charName: "IC Weener", shard: "ForgottenRealm", owner: "JohnDoe", roles: ["DD", "Heal"], charClass: "Noob" };
var testCharacter3 = { charName: "Poor Moe", shard: "Springfield", owner: "Fox", roles: ["Barkeep"], charClass: "Toon" };

//we use this character to verify that duplicate characters are avoided
var faultyCharacter1 = { charName: "Leroy Jenkins", shard: "SomeServer", owner: "Nemesis", roles: ["Casualty", "Roadkill"], charClass: "Berzerk" };
//and this one to verify that duplicate recognition is NOT case sensitive
var faultyCharacter2 = { charName: "leroy jenkins", shard: "someserver", owner: "Nemesis", roles: ["Casualty", "Roadkill"], charClass: "Berzerk" };
...
describe('Character Manager', function () {
    describe('Register a Character', function () {
        it(`Should register a new character for a user. Character name: ${testCharacter1.charName} and Owner: ${testCharacter1.owner}`, function () {
            ...
            charManager.registerCharacter(testCharacter1.charName, testCharacter1.owner);
            console.log(charManager.characterList);
            assert(characterManager.characterList.size(), 1, "Characterlist contains wrong amount of data");
